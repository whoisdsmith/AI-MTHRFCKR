...
- **AI | Articles**: A collection of articles and written resources related to AI.
- **AI | Experiments**: A compilation of AI experiments and projects.
- **AI | Pharampyschaotic**: AI tools and models for generating chaotic patterns.
- **AI | Prompts**: AI-generated prompts and ideas for new projects.
- **AI | Resources**: A curated list of resources and links related to AI.
- **AI | Specific OpenAI Direct Playground Links**: Links to specific OpenAI models in the OpenAI Direct Playground.
- **AI | Templates and Starter Kits**: AI templates and starter kits to help you get started with your own projects.
- **AI | Twitter People**: A list of AI experts and enthusiasts on Twitter to follow.
...
- **3D and Animation**: AI tools for creating 3D animations and models.
- **Apps**: AI-powered apps for art and image processing.
- **Art**: AI models and tools for creating digital art.
- **Avatars**: AI models and tools for creating digital avatars.
- **Collab**: AI tools for collaborating on art and image projects.
- **Editing**: AI tools for editing and enhancing images.
- **Free**: A collection of free AI-powered art and image tools.
- **Generator**: AI tools for generating images and art.
- **Image**: AI tools for processing and analyzing images.
- **Logo Generator**: AI tools for generating logos.
- **No Code Tools**: AI tools for art and image processing that do not require code.
...
- **Stable Diffusion**: AI tools for applying stable diffusion filters to images.
- **StyleGAN**: AI models and tools based on the StyleGAN architecture.
- **Super-Resolution**: AI tools for increasing the resolution of images.
- **Tools**: A collection of AI-powered tools for art and image processing.
...
- **Audio**: A collection of AI models and tools that can process audio signals and perform tasks such as noise reduction, audio compression, and more. 
- **Editing**: AI tools for audio editing, cutting, and arranging. These tools allow you to manipulate audio files with ease and efficiency.
- **Music**: AI models and tools that can generate music, play instruments, and analyze audio tracks. With these tools, you can create and modify musical compositions, and analyze musical structures.
- **Speech**: AI models and tools for speech recognition, synthesis, and analysis. These tools can help you transcribe speech, synthesize speech, and perform speech analysis tasks.
...
- **Customer Support**: AI tools for providing customer support, including chatbots, virtual assistants, and more. 
- **Human Resources**: AI models and tools for human resources tasks, such as resume screening and interview scheduling.
- **Reviews & Recommendations**: AI tools for processing and analyzing customer reviews and generating product recommendations.
- **Search Engine**: AI-powered search engines that can help you find the information you need.
- **SEO**: AI tools for optimizing your website for search engines, including keyword analysis and backlink analysis.
- **Startup**: AI tools and resources for startups, including financial modeling, marketing, and more.
...
- **Content**: AI tools and models for generating content, such as articles, stories, and more. 
- **Creators Toolkit**: Tools and resources for content creators, including templates, design tools, and more. 
- **Social Media Assistant**: AI tools for managing social media accounts, including scheduling, content generation, and more.
...
- **Data**: AI tools and models for processing and analyzing data, including data visualization, data cleaning, and more. 
- **Spreadsheets**: AI-powered spreadsheets that can help you analyze and visualize data with ease.
- **SQL**: AI tools for working with SQL databases, including SQL query generation, SQL optimization, and more.
...
- **Architecture**: AI tools for architectural design, including building design, interior design, and more. 
- **Assistant**: AI tools for assisting with design tasks, including color selection, design inspiration, and more.
- **Web Design**: AI tools for web design, including website builders, design templates, and more.
...
- **Code**: AI tools and models for writing and analyzing code, including code completion, code optimization, and more. 
- **Code Assistant**: AI tools for assisting with coding tasks, including debugging, testing, and more.
- **Database**: AI tools for working with databases, including database design, data modeling, and more.
- **Developer Tools**: AI tools and resources for developers, including project management, collaboration, and more.
- **Github**: AI tools for working with Github, including repository management, pull request analysis, and more. 
- **No Code**: AI tools for building applications without writing code, allowing for faster development and reduced complexity.
...
- **Education and Learning**: A collection of resources and tutorials to help you learn AI concepts and technologies. 
- **Learn Generative AI**: A series of educational resources and tutorials to help you understand and use generative AI models.
- **Research**: Tools and resources for conducting AI research, including data sets, papers, and research reports.
...
- **Fun With AI**: A collection of fun AI applications, such as games, animations, and art. 
- **Gaming**: AI tools and models for game development, including game engines, physics simulations, and AI-powered game characters.
- **AI-Health**: AI tools and resources to help you monitor and improve your health and wellness. 
- **Health**: A collection of AI models and tools to help you manage your health and wellness, such as fitness trackers and personal health records. 
- **Life Assistant**: AI tools and resources to help you manage your daily life, such as to-do lists, reminders, and calendars.
- **Memory**: AI tools and resources to help you improve your memory, such as memory games and mnemonics.
...
- **Fashion**: AI tools and resources for the fashion industry, such as fashion design, virtual fitting rooms, and personal stylists. 
- **Gift Ideas**: AI tools and resources for finding and selecting gifts, such as gift recommendations and gift registries. 
- **Legal**: AI tools and resources for the legal industry, such as legal document automation, contract analysis, and legal research. 
- **Misc**: Miscellaneous AI tools and resources that don't fit into any other categories. 
- **Real Estate**: AI tools and resources for the real estate industry, such as property listings, real estate market analysis, and property investment tools.
...
- **Chat**: AI-powered chat tools and resources, including chatbots and conversational AI. 
	- **ChatGPT**: An AI-powered chatbot that can assist you with your questions and tasks. 
- **Docs**: AI tools for document processing, including text recognition, document summarization, and document analysis. 
- **Email Assistant**: AI tools and resources to help you manage your email, including email filtering, email summarization, and email organization. 
- **Productivity**: AI tools and resources to help you be more productive, including time management, task management, and productivity tracking. 
- **Sales & Marketing**: AI tools and resources for sales and marketing, including lead generation, customer segmentation, and marketing analytics. 
- **Summarizer**: AI tools and resources for text summarization, including news summarization, document summarization, and video summarization.
...
- **Apps**: AI models and tools that can be used to develop and enhance applications. 
- **iOS**: AI models and tools that are specifically designed for iOS platforms. 
- **Software**: AI models and tools that can be used for general software development and automation.
...
- **Text**: AI models and tools that can process, analyze, and generate text.
- **Text To Speech**: AI models and tools for speech synthesis and generation from written text.
...
- **Automation**: AI models and tools for automating various tasks and processes. 
- **Tools**: A variety of AI tools that can be used for various applications and industries.
- **Translation & Transcript**: AI models and tools for translation and transcriptions.
...
- **Video**: AI models and tools that can process, analyze, and generate video.
- **Video Animation**: AI models and tools for generating and manipulating video animations. 
- **Video Channels**: AI models and tools for managing and optimizing video channels. 
- **Video Editing**: AI models and tools for video editing and post-production. 
- **Video Generator**: AI models and tools for video generation and creation. 
- **Video Interpolation**: AI models and tools for video interpolation and resizing. 
- **Video Personalized**: AI models and tools for personalized video recommendations and content.
...
- **Assistant**: AI models and tools for writing assistance and suggestions. 
- **Copywriting**: AI models and tools for copywriting and content creation. 
- **General**: AI models and tools for general writing and language processing. 
- **Paraphraser**: AI models and tools for paraphrasing and rewording text. 
- **Story Teller**: AI models and tools for story generation and storytelling. 
- **Writing**: AI models and tools for writing analysis and improvement.
...
- [ChatGPT Prompts](http://promptschatgpt.com/) - Top ChatGPT Prompts
...
- [Effective GPT](https://www.effectivegpt.com/) - Get Accurate ChatGPT Prompts
- [Everyprompt](https://www.everyprompt.com/) - A Playground For GPT-3]
...
- [Jrnylist](https://www.jrnylist.com/) - Midjourney Prompt Helper
- [KREA](https://www.krea.ai/)
- [Latentspace](https://www.latentspace.dev/) - Exploring Stable Diffusion Latent Space
...
- [PromptHero](https://prompthero.com/?ref=futurepedia)–Prompter Is An AI Prompt Sharing Community Where People Can Share ChatGPT, Midjourney And Other AI Prompts. Discover Prompts That Rock!
...
- [Prompt Bookmarks](https://raindrop.io/whoisdsmith/prompts-29978194/sort=title&perpage=30&page=0)
...
- [Logo Rank](http://brandmark.io) Brandmark Logo Maker - The Most Advanced Ai Logo Design Tool
...
- [AI Image Enlarger](http://imglarger.com) Ai Image Enlarger - Enlarge Image Without Losing Quality!
- [AVC AI](http://avc.ai) Online Ai Image Enhancer That Improves Photo Quality By Upscaling, Denoising, Restoring, Face Refinement, And More
- [Claid.ai](http://claid.ai) Claid. Ai Automated Photo Enhancer For Ugc. Web, Mobile & Printing. AI Software To Enlarge Images With No Quality Loss, Correct Colors, Increase Resolution, Retouch Product Photos And Edit UGC Automatically.
- [Colorize](http://colorize.cc) Colorize Photo Online
- [ExtendImage](http://www.extendimage.ai) Extendimageai - Extend Your Images With Generative Ai. ExtendImageAI Is A Tool That Allows You To Extend Your Images With Generative AI.
- [Hama](http://www.hama.app) Hama. Amazing Photo Eraser.
- [Imgupscaler](http://imgupscaler.com) Smart Png / Jpg Image Upscaler. Upscale And Enhance Your Image By Using The Latest AI Technology.
- [Magic Eraser](http://magicstudio.com) Magic Studio - Powered By Ai, Created By You. Magic Studio Helps You Automatically Edit And Create Images, Using AI.
- [Palette](http://palette.fm) Palette - Colorize Photos. A New AI Colorizer. Colorize Anything From Old Black And White Photos ð¸, Style Your Artworks ð¨, Or Give Modern Images A Fresh Look ð¶. It's As Simple As Instagram.
- [PhotoFix](http://photofix.io) Photofix - Magically Edit Photos With Ai
- [Photorestoration](http://photorestoration.ai) Old Photo Restoration Online - Photorestoration. Ai
- [Photospells](http://photospells.com) Photo Spells - Professional Photo Edition With Ai
...
- [Remover.app](http://remover.zmo.ai) Removeanythingunwanted In Seconds, For Free.
...
- [SceneryAI](http://sceneryai.com) Sceneryai. Generate Or Update Existing Images With Our AI Image Editing Tool.
- [Stillgram](http://stillgram.io) Stillgram™ - A. I. Travel Photo Camera App For Iphone®. Stillgram Is An A. I. Point & Shoot Camera App That Magically Removes Background Crowds From Your Urban/travel Photos.
- [Topaz Photo AI](http://www.topazlabs.com) Topaz Labs Ai Image Quality Software. Photo And Video Enhancement Software Powered By Deep Learning Gets You The Best Image Quality Available For Noise Reduction, Sharpening, Upscaling, And More.
- [Unfake](http://unfakepng.com) Ai Tool That Can Turn Annoying Fake. Png Into True, Unfake. Png. Don&apos; T You Hate It When You Find That Perfect, Supposedly Background-less Image, And Download It, But When You Go To Use It, The Dreaded Checkerboard Appears?.
- [JpgRM](http://jpgrm.com) Jpgrm - Ai Image Magic Cleanup. Using 2022 Cutting Edged AI Model To Remove Any Unwanted Objects From Your Images, Automatically Fill The Background.
- [Jpghd](http://jpghd.com) Jpghd - Lossless Restoration Of Old Photos With Ai. Using 2022 Cutting-edge AI Models For Lossless Restoration Of Old Photos (Supports Old, Scratched Photo Restoration, Colorization, And Magic Photo).

## Plugins & Extensions

- [AIduh](http://aiduh.com) Ai-Responder For Hostaway - Ai Duh. Chrome Extension That Cuts Your Writing Time By 98% With AI-powered Responses. Built By Hosts For Hosts.
- [Autoname](http://www.autoname.org) Rename All Your Layers In One Click. Thanks To Ai. Open Source. Rename Figma Frames In One Click, That's Pretty Much It.
- [Merlin](http://merlin.foyer.work) Merlin. Free Open AI&apos; S ChatGPT Powered Extension To Use Anywhere!.
- [SplashAI](http://www.splashai.art) Splashai Is A Figma Plugin, Search Engine And Ai Image Generator
